...
export default function ProductsManager() {
  ...
  const handleToggleActive = async (product: Product) => {
    try {
      ...
      await axios.patch(
        `https://barberrock.es/api/productos/${product.id}/`,
  ...
  const handleEdit = (product: Product) => {
    ...
    setPreviewUrl(product.imagen ? `https://barberrock.es${product.imagen}` : null)
    setSelectedImage(null)
    setShowModal(true)
  }
  ...
  const handleDelete = async (product: Product) => {
    ...
    try {
      ...
      await axios.delete(`https://barberrock.es/api/productos/${product.id}/`, {
        headers: {
          ...authHeaders,
        },
      })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing && currentProduct) {
        await axios.patch(`https://barberrock.es/api/productos/${currentProduct.id}/`, payload, {
          headers: {
            ...authHeaders,
        ...
        await axios.post('https://barberrock.es/api/productos/', payload, {
          headers: {
            ...authHeaders,
            'Content-Type': 'multipart/form-data',
          },
